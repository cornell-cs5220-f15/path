...
\noindent The following section describes the implementation of MPI, chosen for its ease of implementation and decent performance. Additionally, we have not been able to run on multiple nodes of Totient at once using MPI, preventing our implementation of a heterogeneous parallelization method mentioned above in statement~(2).
