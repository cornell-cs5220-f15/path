...
\noindent When used correctly, the \texttt{DEF} -- \texttt{USE} strategy can be quite effective at optimizing.  Comparing to the base code, including this simple two-phase process gives the following increases:

\begin{center}
  THIS IS A FIGURE SHOWING RESULTS OF VECTORIZATION FROM ICC
\end{center}
