 ...
 * identical, and false otherwise. (eg, if this operation didn't find any new shorter paths)
 */
           ...
           int* restrict lnew)  // Partial distance at step s+1
{
  ...
  /* l and lnew should be shared */
  /* all independent done vars are &&'d together at end of outer for loop*/
